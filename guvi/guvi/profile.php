...
<body background="book.jpg">
    ...
    <div class="center" style="border-width:9px; border-style:solid; border-color:black;height: 850px;width: 500px;margin:40px 520px;">
    <div class="update_form">
        
        <div class="mb-3">
            <label for="FullName" class="form-label"><b>Full Name</b></label>
            <input type="text" class="form-control" value="<?php echo $USERNAME ?>" id="exampleFormControlInput1" name="FullName" placeholder="Ex: Supritha" style="width: 400px;">
        </div>
        <div class="mb-3">
